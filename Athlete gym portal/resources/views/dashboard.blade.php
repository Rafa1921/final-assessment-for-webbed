                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Reviews Featured</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $user->reviewsFeatured($user->id) }}</td>
